...
const CEREMONY_PACKAGES = [
  { id: '9', name: 'แพ็คเกจจัดงานทำบุญบ้าน/แต่งงาน (พิธีไทย)', price: 35000, category: 'พิธีไทย', imageUrl: '/jadhai/assets/pkg_thai_ceremony_1776367980521.png', description: 'บริการรับจัดพิธีสงฆ์ครบวงจร พร้อมอาสนะ โต๊ะหมู่บูชา ชุดพานพุ่ม นิมนต์พระสงฆ์ และจัดเตรียมภัตตาหารถวายพระ ดำเนินการโดยศาสนพิธีกรมืออาชีพ' },
  { id: '10', name: 'แพ็คเกจไหว้บรรพบุรุษ/ตั้งศาลตี่จู้เอี๊ยะ (พิธีจีน)', price: 28000, category: 'พิธีจีน', imageUrl: '/jadhai/assets/pkg_chinese_ceremony_1776367995197.png', description: 'บริการรับจัดพิธีตั้งศาลตี่จู้เอี๊ยะ หรือไหว้บรรพบุรุษชุดใหญ่ พร้อมหมูหัน เป็ดย่าง ผลไม้มงคลพรีเมียม ขนมมงคล และกระดาษเงินกระดาษทองแบบจัดเต็มเพื่อความเป็นสิริมงคลสูงสุด' },
  { id: '11', name: 'แพ็คเกจบวงสรวงตั้งศาลพระภูมิ (พิธีพราหมณ์)', price: 55000, category: 'พิธีพราหมณ์', imageUrl: '/jadhai/assets/pkg_brahmin_ceremony_1776368009598.png', description: 'พราหมณ์หลวงพร้อมทีมงานจัดทำพิธีบวงสรวงตั้งศาลพระพรหม ศาลพระภูมิ ศาลตายาย จัดเตรียมบายศรีวิจิตรแท้ขนาดใหญ่ และเครื่องขมาบูชาอย่างถูกต้องครบถ้วนตามขนบธรรมเนียม' },
  { id: '12', name: 'แพ็คเกจบูชาองค์เทพ/พิธีนวราตรี (พิธีฮินดู)', price: 42000, category: 'พิธีฮินดู', imageUrl: '/jadhai/assets/pkg_hindu_ceremony_1776368024355.png', description: 'บริการตกแต่งเทวาลัย อารตีไฟ พร้อมประดับตกแต่งด้วยพวงมาลัยดอกดาวเรืองสด ถวายขนมลาดู โมทกะ และเครื่องบูชาองค์เทพ บริการนำสวดโดยพราหมณ์สายอินเดียแท้' }
];
